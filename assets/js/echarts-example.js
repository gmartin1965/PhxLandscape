(function (factory) {
  ...
  const basicBarChartInit = () => {
    ...
    const months = ["Ahead of Schedule (3 Crews)", "Behind Schedule (5 Crews)"];
    const data = [1020, 1160];
    const colorPalette = ["primary", "danger"];
        ...
        series: [
          {
            ...
            itemStyle: {
              color: function (params) {
                return getColor(colorPalette[params.dataIndex]);
              },
              // getColor("primary"),
  ...
  const barNegativeChartInit = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector(
      ".echart-bar-negative-chart-example"
    );
  ...
  const stackedBarChartInit = () => {
    const { getColor, getData, rgbaColor } = window.phoenix.utils;
    const $chartEl = document.querySelector(
      ".echart-stacked-bar-chart-example"
    );
  ...
  const barGradientChartInit = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector(
      ".echart-bar-gradient-chart-example"
    );
  ...
  const pieMultipleChartInit = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl = document.querySelector(
      ".echart-pie-multiple-chart-example"
    );
    const data1 = [
      {
        value: 1048,
